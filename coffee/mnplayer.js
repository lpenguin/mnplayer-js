(function() {
  ...
  App.Templates.Player = "<div class=\"play-button symbol clickable\">|>&nbsp;</div>" + "<div class=\"pause-button hidden symbol clickable\">||&nbsp;</div>" + "<div class=\"symbol\">[</div>" + "<div class=\"seek-bar symbol clickable\"></div>" + "<div class=\"symbol\">&nbsp;</div>" + "<div class=\"time symbol\"></div>" + "<div class=\"symbol\">]</div>" + "&nbsp;" + "<div class=\"symbol info clickable\">[i]</div>" + "<div class=\"symbol home-page clickable\">[?]</div><br/>";
  ...
  App.Views.Player = Backbone.View.extend({
    initialize: function(options) {
      ...
      if (options.duration) {
        this.manualDuration = fromTimer(options.duration);
      }
      this.info = options.info || this.getinfo();
      this.showMode = 'bar';
      this.messagePosition = 0;
      if (options.message) {
        return this.showMessage(options.message);
      }
    },
    getinfo: function() {
    ...
    setBarMode: function() {
      ...
      if (this.messageInterval) {
        return clearInterval(this.messageInterval);
      }
    },
    ...
    durationchange: function(e) {
      ...
      if (this.manualDuration) {
        return this.duration = this.manualDuration;
      }
    },
